...
- (void)webViewDidFinishLoad:(UIWebView *)webView
{
    ...
    [webView stringByEvaluatingJavaScriptFromString:@"document.getElementById('banner_center').style.display = 'none';document.getElementsByClassName('line')[0].style.display = 'none'"];
}
